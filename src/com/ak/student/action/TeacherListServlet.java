...
@WebServlet(name = "TeacherListServlet",value = "/manage/teacher/TeacherListServlet")
        ...
        if(method == null){
            ...
            try {
                if(request.getParameter("t_name")==null) {
                    request.setAttribute("teacherList", tdi.getList());
                }
                else {
                    request.setAttribute("teacherList", tdi.getList(request.getParameter("t_name")));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if(method.equals("delete")){
                ...
                int id = Integer.parseInt(request.getParameter("post"));
                try {
                    request.setAttribute("teacher",tdi.getOne(id));
                } catch (Exception e) {
                    e.printStackTrace();
                }
