    ...
    <form action="UpdateTeacherServlet" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                <p>编号:</p>
                <p><input type="text" name="t_no" class="loginInput"  required="required"  placeholder="请输入编号"/></p>
                <p>姓名:</p>
                <p><input type="text" name="t_name" class="loginInput" required="required" placeholder="请输入姓名"/></p>
                <p>性别:</p>
                <p>
                    <select name="t_sex">
                ...
                <p>年龄:</p>
                <p><input type="text" name="t_age" class="loginInput" required="required" placeholder="请输入年龄"/></p>
