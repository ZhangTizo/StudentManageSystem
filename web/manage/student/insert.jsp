    ...
    <form action="UpdateStudentServlet" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                ...
                <p>姓名:</p>
                <p><input type="text" name="s_name" class="loginInput" required="required" placeholder="请输入姓名"/></p>
                <p>性别:</p>
                <p>
                    <select name="s_sex">
                ...
                <p>年龄:</p>
                <p><input type="text" name="s_age" class="loginInput" required="required" placeholder="请输入年龄"/></p>
                <p>备注:</p>
