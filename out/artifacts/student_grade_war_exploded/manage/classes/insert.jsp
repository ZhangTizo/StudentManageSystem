    ...
    <form action="UpdateClassesServlet" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                ...
                <p>课程名:</p>
                <p><input type="text" name="c_name" class="loginInput" required="required" placeholder="请输入课程名"/></p>
                <p>教师号:</p>
                <p><input type="text" name="t_no" class="loginInput" required="required" placeholder="请输入教师号"/></p>
                <p>备注:</p>
