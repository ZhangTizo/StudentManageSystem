    ...
    <form action="UpdateUser" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                <p style="font-weight: bold">当前用户：<c:out value="${username}"></c:out></p>
                <p>原密码:</p>
                <p><input type="password" name="password" class="loginInput" required="required" placeholder="请输入原密码"/></p>
                <p>新密码:</p>
